...
import com.jielkko.calendar.ChinaDate;
...
import static com.jielkko.calendar.CalendarUtil.getDayOfWeek;
...
public class CalendarFactory {
    ...
    //获取一月中的集合
    public static List<CalendarBean> getMonthOfDayList(int y, int m,List<String> markList) {
        ...
        for (int i = fweek - 1; i > 0; i--) {
            ...
            Boolean isMark = markList.contains(bean.toDateString());
            bean.isMark = isMark;
            list.add(bean);
        }
