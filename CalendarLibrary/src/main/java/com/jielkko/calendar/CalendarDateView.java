...
import com.jielkko.calendar.CalendarTopView;
...
import static com.jielkko.calendar.CalendarFactory.getMonthOfDayList;
...
public class CalendarDateView extends ViewPager implements CalendarTopView {
    ...
    public void setMark(List<String> markList) {
       ...
       final int[] dateArr= CalendarUtil.getYMD(new Date());
        ...
        setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                view.setData(getMonthOfDayList(dateArr[0],dateArr[1]+position-Integer.MAX_VALUE/2,markList),position==Integer.MAX_VALUE/2);
